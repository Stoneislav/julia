...
- Если число сделанных шагов робота чётно, то робот ставит маркер в начальную клетку(state = 1), иначе не ставит и начинает маркировку со второй клетки(state = 0)
